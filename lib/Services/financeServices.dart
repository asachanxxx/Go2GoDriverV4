...
class FinanceService {
  ...
  static Future<DateWiseSummary> getdateWiseSummary(context) async{
    ...
    var snapShotx=  await FirebaseDatabase.instance.reference().child('drivers/${CustomParameters.currentFirebaseUser.uid}/dateWiseSummary/$datestring').once();
  ...
  static Future<CashFlows> getCashDlows(context) async{
    var snapShotx=  await FirebaseDatabase.instance.reference().child('drivers/${CustomParameters.currentFirebaseUser.uid}/cashFlows').once();
    if(snapShotx.value == null){
  ...
  static Future<bool> earningTryOut(DateWiseSummary summary) async{
    var datestring = makeDateString();
    print("earnignTryOut Firebase Path ${'drivers/${CustomParameters.currentFirebaseUser.uid}/$datestring'}");
    var reg= FirebaseDatabase.instance.reference().child('drivers/${CustomParameters.currentFirebaseUser.uid}/dateWiseSummary/$datestring');
  ...
  static Future<bool> updatedateWiseSummary(DateWiseSummary summary) async{
    ...
    var  exxistingValue = await FirebaseDatabase.instance.reference().child('drivers/${CustomParameters.currentFirebaseUser.uid}/dateWiseSummary/$datestring').once();
  ...
  static Future<bool> updateEarningOnly(double earning) async{
    double exValue = 0;
    var datestring = makeDateString();
    print("updateEarningOnly Firebase Path ${'drivers/${CustomParameters.currentFirebaseUser.uid}/dateWiseSummary/$datestring/totalEarning'}");

    var  exxistingValue = await FirebaseDatabase.instance.reference().child('drivers/${CustomParameters.currentFirebaseUser.uid}/dateWiseSummary/$datestring/totalEarning').once();
    ...
    await FirebaseDatabase.instance.reference().child('drivers/${CustomParameters.currentFirebaseUser.uid}/dateWiseSummary/$datestring/totalEarning').set(exValue + earning);
    return Future.value(true);
  }
  ...
  static Future<bool> updateCashFlows(CashFlows summary) async{
    ...
    var  exxistingValue = await FirebaseDatabase.instance.reference().child('drivers/${CustomParameters.currentFirebaseUser.uid}/cashFlows/').once();
    ...
    var reg= FirebaseDatabase.instance.reference().child('drivers/${CustomParameters.currentFirebaseUser.uid}/cashFlows/');
