...
class DailyParameters {
  ...
  DailyParameters.fromSnapshot(DataSnapshot snapshot) {
     earning = snapshot.value['earning'] != null ? snapshot.value['earning'] :0.00;
     commission = snapshot.value['commission'] != null ? snapshot.value['commission'] : 0.00;
     driveHours = snapshot.value['driveHours'] != null ? snapshot.value['driveHours'] :0.00;
     totalDistance = snapshot.value['totalDistance'] != null ? snapshot.value['totalDistance'] : 0.00;
